                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="table-td">
                        ...
                        <button type="button" class="text-red-500 text-xs hover:underline"
                                @click="openConfirm('{{ route('admin.equipment.destroy', $equip) }}')">Xoá</button>
                    </td>
                </tr>
                @empty
    ...
    <div x-show="confirmOpen"
        ...
        <div class="bg-white rounded-xl shadow-xl pointer-events-auto" style="width:360px;max-width:calc(100vw - 2rem)" @click.stop>
            <div class="flex items-center gap-2.5 px-4 pt-4 pb-3">
                ...
                <div class="flex-1">
                    <p class="font-semibold text-gray-900 text-sm">Xoá thiết bị</p>
            ...
            <p class="text-xs text-gray-500 px-4 pb-4">Bạn có chắc muốn xoá thiết bị này không?</p>
